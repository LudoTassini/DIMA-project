...
void main() {
  ...
  testWidgets('Editable chapter present', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget(editable: true));
    expect(find.byType(BloqoEditableChapter), findsOneWidget);
  });

  testWidgets('Editable chapter can be tapped (if editable)', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget(editable: true));
  ...
  testWidgets('Editable chapter can be tapped (if not editable)', (WidgetTester tester) async {
  ...
  testWidgets('Editable chapter can be deleted (if editable)', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget(editable: true));
  ...
  testWidgets('Editable chapter cannot be deleted (if not editable)', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget(editable: false));
