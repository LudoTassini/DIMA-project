...
void main() {
        ...
        home: MultiProvider(
          ...
          child: Builder(
              builder: (BuildContext context) {
                return Scaffold(
                  body: BloqoCourseEnrollmentRequestNotification(
  ...
  testWidgets('Course enrollment request notification present', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget());
    expect(find.byType(BloqoCourseEnrollmentRequestNotification), findsOneWidget);
  });
