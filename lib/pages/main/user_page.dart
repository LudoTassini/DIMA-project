                      ...
                      child: Column(
                        ...
                        children: [
                          BloqoUserDetails(
                            ...
                            onReplacePicture: () async {
                              ...
                              if (newUrl != null) {
                                ...
                                updateUserPictureUrlInAppState(context: context,
                                    newUrl: newUrl);
                              }
                            },
                          ),
                          BloqoSetting(
                            ...
                            settingDescription: localizedText
                                  ...
                                  Form(
                                    ...
                                    child: BloqoTextField(
                                      ...
                                      validator: (String? value) {
                                        return fullNameValidator(fullName: value,
                                            localizedText: localizedText);
                                      },
                          ...
                          BloqoSetting(
                            ...
                            settingDescription: localizedText
                                .application_settings_description,
                            settingIcon: Icons.settings_applications_rounded,
                            onPressed: () {
                              widget.onPush(SettingPage(
                                  settingTitle: localizedText
                                              ...
                                              child: LayoutBuilder(
                                                  builder: (BuildContext context,
                                                    ...
                                                    String languageInitialSelection = languages
                                                        .firstWhere(
                                                            ...
                                                            lang.value.toLowerCase()
                                                                .startsWith(
                                                                getLanguageFromAppState(
                                                                    context: context)
                                                                    .languageCode,
                                                                ("BloqoLanguageTagValue.")
                                                                    .length))
                                                        .label;
                                                    ...
                                                    languageController.text =
                                                        languageInitialSelection;
                                                    themeController.text =
                                                        themeInitialSelection;
                                  ...
                                  onSettingsUpdated: () =>
                                      _updateUserPage(localizedText: localizedText)
                              ));
                            },
                          ),
                          BloqoSetting(
