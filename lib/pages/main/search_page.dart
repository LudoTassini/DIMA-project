        ...
        builder: (context, applicationSettingsAppState, _) {
          ...
          return BloqoMainContainer(
            child: Padding(
              ...
              child: Padding(
                padding: !isTablet ? const EdgeInsetsDirectional.all(0) : Constants
                    .tabletPadding,
                child: Column(
                                    ...
                                    child: Form(
                                        ...
                                        child: BloqoTextField(
                                            ...
                                            onTap: () async {
                                              ...
                                              setState(() {
                                                if (picked == null) {
                                                  minimumPublicationDateController
                                                      .text = "";
                                                }
                                                else {
                                                  minimumPublicationDateController
                                    ...
                                    child: Form(
                                        ...
                                        child: BloqoTextField(
                                            ...
                                            onTap: () async {
                                              ...
                                              setState(() {
                                                if (picked == null) {
                                                  maximumPublicationDateController
                                                      .text = "";
                                                }
                                                else {
                                                  maximumPublicationDateController
                                            ...
                                            return Row(
                                                ...
                                                children: [
                                                  BloqoDropdown(
                                                    ...
                                                    initialSelection: sortingOptions[0]
                                                        .value,
                                                    width: availableWidth,
                                                  )
                                                ]
