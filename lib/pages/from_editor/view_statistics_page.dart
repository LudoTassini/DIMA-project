                                  ...
                                  Flexible(
                                    child: Row(
                                      children: [
                                        ...
                                        BloqoTextButton(
                                          text: widget.publishedCourse
                                              .authorUsername,
                                          color: theme.colors.highContrastColor,
                                          onPressed: () async {
                                            await _tryGoToProfilePage(
                                                context: context,
                                  ...
                                  child: Column(
                                      children: [
                                        ...
                                        Row(
                                            children: [
                                              Text(
                                                widget.publishedCourse
                                                    .numberOfEnrollments.toString(),
                                                style: theme
                                                    .getThemeData()
                                                    .textTheme
                                                    .displayMedium
                          ...
                          BloqoSeasaltContainer(
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...List.generate(
                                    _reviewsDisplayed > widget.publishedCourse
                                        .reviews.length
                                        ?
                                    widget.publishedCourse.reviews.length
                                        : _reviewsDisplayed,
                                    ...
                                    child: Text(
                                      localizedText.published_on +
                                          DateFormat('dd/MM/yyyy').format(widget
                                              .publishedCourse.publicationDate
                                              .toDate()),
                                      style: Theme
                                          .of(context)
                                          .textTheme
