                ...
                builder: (context, userCoursesEnrolledAppState, _) {
                  ...
                  return Consumer<LearnCourseAppState>(
                      builder: (context, learnCourseAppState, _) {
                        ...
                        Map<String, List<BloqoSectionData>> sections = getLearnCourseSectionsFromAppState(
                            context: context) ?? {};
                        Timestamp enrollmentDate = getLearnCourseEnrollmentDateFromAppState(
                            context: context)!;
                        List<dynamic> sectionsCompleted = getLearnCourseSectionsCompletedFromAppState(
                            context: context) ?? [];
                        List<dynamic> chaptersCompleted = getLearnCourseChaptersCompletedFromAppState(
                            context: context) ?? [];
                        int totNumSections = getLearnCourseTotNumSectionsFromAppState(
                            context: context)!;
                        String? sectionToComplete = userCourseEnrolled
                            .sectionToComplete;
